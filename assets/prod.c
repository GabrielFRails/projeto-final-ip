    ...
    while(ref==0){
        ...
        switch(entrada){
            ...
            case 2:
                ...
                printf("%d mes antes do incremento\n", data.mm);
                incrementar_mes(&data.mm, &data.yy);
                printf("%d mes depois do incremento\n", data.mm);
                decrementar_mes(&data.mm, &data.yy);
                printf("%d voltou ao original\n", data.mm);
                decrementar_mes(&data.mm, &data.yy);
                printf("%d me agora decrementei\n", data.mm);
                break;
